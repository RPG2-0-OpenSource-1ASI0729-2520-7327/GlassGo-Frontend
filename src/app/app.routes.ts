...
import { CreateOrderComponent } from './planning/presentation/view/create-order/create-order';
...
import { TrackingComponent } from './Execution/presentation/views/tracking/tracking';
...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'tracking', component: TrackingComponent, title: 'Tracking - GlassGo' },
